...
function setup() {
	...
	let player1 = new Player('../static/assets/paddle_p1.svg', 0, 0, 'h');
	let player2 = new Player('../static/assets/paddle_p2.svg', 0, 0, 'v');
	let player3 = new Player('../static/assets/paddle_p3.svg', 0, screenHeight - 30, 'h');
	let player4 = new Player('../static/assets/paddle_p4.svg', screenWidth - 30, 0, 'v');
